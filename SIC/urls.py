...
from gestion_ucp import views as gestion_ucp_views
...
urlpatterns = [
    ...
    # ----- Gestión UCP -----
    path('gestion-ucp/', gestion_ucp_views.gestion_ucp_view, name='gestion_ucp'),

    # ----- Costos Indirectos -----
    path('costos-indirectos/', costos_views.costos_indirectos_view, name='costos_indirectos'),
